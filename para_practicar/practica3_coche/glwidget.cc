...
void _gl_widget::keyPressEvent(QKeyEvent *Keyevent)
{
  ...
  case Qt::Key_W:Test.ruedas_avanzar();break;
  case Qt::Key_S:Test.ruedas_retroceder();break;
  case Qt::Key_A:Test.eje_delantero_izquierda();break;
  case Qt::Key_D:Test.eje_delantero_derecha();break;
